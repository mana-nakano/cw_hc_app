                ...
                <header className="flex justify-between items-center p-8 bg-white border-b shadow-sm">
                    <div className="flex items-center gap-4">
                        <div>
                            ...
                            <p className="text-[#f26522] text-sm font-bold mt-2 uppercase tracking-widest text-[10px] md:text-sm">業務用塗料に関するお問い合わせはこちら！</p>
                        </div>
                    </div>
                    <div className="flex flex-col items-end gap-2">
                        ...
                        <p className="text-gray-400 text-xs md:text-sm font-bold tracking-tighter mr-2 uppercase">受付時間: 9:00 - 17:00</p>
                    </div>
                </header>
